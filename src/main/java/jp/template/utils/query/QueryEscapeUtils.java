...
public final class QueryEscapeUtils {
	 ...
	 * This method does not escape full-width wildcards since 1.0.2. <strong>If you escape '％' and '＿', use <code>QueryEscapeUtils.withFullWidth().toLikeCondition(condition)</code></strong>
	 * </p>
	 * 
